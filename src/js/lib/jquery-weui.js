...
function getTouchActionProps() {
    ...
    ['auto', 'manipulation', 'pan-y', 'pan-x', 'pan-x pan-y', 'none'].forEach(function(val) {
        ...
        // If scss.supports is not supported but there is native touch-action assume it supports
...
/**
 * add/remove the scss properties as defined in manager.options.cssProps
 * @param {Manager} manager
 * @param {Boolean} add
 */
